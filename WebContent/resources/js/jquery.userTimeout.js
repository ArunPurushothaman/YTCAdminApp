...
//code included to initialize timeout popup
...
;(function ($, document, window, undefined) {
	...
	$.fn.userTimeout = function (opts) {
		...
		var defaults = {
			...
			modalBody: 'You\'re being timed out due to inactivity. Please choose to stay signed in or to logoff. Otherwise, you will be logged off automatically.'  // Modal body content
		};

		var options = $.extend(defaults, opts || {});

		var modalUI, timeout, forceLogout, countDownTimer, seconds = Math.floor((options.force / 1000));
