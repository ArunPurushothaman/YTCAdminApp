    ...
    return {
        ...
        init: function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[14].innerHTML = '<a class="cancel" href="">Cancel</a>';
            }
            ...
            var oTable = $('#pricing-request').dataTable({
                "aLengthMenu": [
                    [10, 20, 50, -1],
            ...
            jQuery('#pricing-request_wrapper .dataTables_filter input').addClass("form-control medium"); // modify table search input
            jQuery('#pricing-request_wrapper .dataTables_length select').addClass("form-control xsmall"); // modify table per page dropdown

            var nEditing = null;

            $('#pricing-request_new').click(function (e) {
                e.preventDefault();
            ...
            $('#pricing-request a.delete').live('click', function (e) {
                e.preventDefault();
            ...
            $('#pricing-request a.cancel').live('click', function (e) {
                e.preventDefault();
            ...
            $('#pricing-request a.edit').live('click', function (e) {
                e.preventDefault();
